...
class DuffelPlaceSearch(DuffelAPIConnector):
    ...
    def _get_mock_places(self, query: str) -> List[Dict[str, Any]]:
        ...
        common_places = [
            {'id': 'arp_jfk', 'name': 'John F. Kennedy International Airport', 'iata_code': 'JFK', 'city_name': 'New York', 'type': 'airport'},
            {'id': 'arp_lax', 'name': 'Los Angeles International Airport', 'iata_code': 'LAX', 'city_name': 'Los Angeles', 'type': 'airport'},
            {'id': 'arp_lhr', 'name': 'London Heathrow Airport', 'iata_code': 'LHR', 'city_name': 'London', 'type': 'airport'},
            {'id': 'arp_cdg', 'name': 'Charles de Gaulle Airport', 'iata_code': 'CDG', 'city_name': 'Paris', 'type': 'airport'},
            {'id': 'arp_nrt', 'name': 'Narita International Airport', 'iata_code': 'NRT', 'city_name': 'Tokyo', 'type': 'airport'},
            {'id': 'arp_dxb', 'name': 'Dubai International Airport', 'iata_code': 'DXB', 'city_name': 'Dubai', 'type': 'airport'},
