...
class TravelSearchAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Status", {"fields": ("is_completed", "created_at", "updated_at")}),
    )
...
class ConsolidatedResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "search")}),
        (
        ...
        ("Raw Data", {"fields": ("raw_openai_response",), "classes": ("collapse",)}),
...
class FlightResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "search", "external_id", "airline")}),
        ...
        ("AI Recommendation", {"fields": ("ai_score", "ai_reason")}),
        ("Raw Data", {"fields": ("raw_data", "is_mock"), "classes": ("collapse",)}),
...
class HotelResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pricing", {"fields": ("price_per_night", "total_price", "currency")}),
        (
            "Hotel Details",
            {
                "fields": (
...
class ActivityResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pricing and Duration", {"fields": ("price", "currency", "duration_hours")}),
        (
            "Activity Details",
            {
                "fields": (
...
class GroupConsensusAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "group", "generated_by", "is_active")}),
        (
            "Consensus Data",
            {
                "fields": (
...
class AIGeneratedItineraryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Budget", {"fields": ("estimated_total_cost",)}),
        ("Status", {"fields": ("is_saved", "created_at", "updated_at")}),
    )
...
class SearchHistoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "user", "search")}),
        (
            "Interaction Data",
            {"fields": ("viewed_results", "saved_itinerary", "shared_with_group")},
        ),
        ("Feedback", {"fields": ("was_helpful", "feedback_text")}),
        ("Metadata", {"fields": ("created_at",)}),
    )
...
class GroupItineraryOptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pricing", {"fields": ("estimated_total_cost", "cost_per_person")}),
        ("AI Analysis", {"fields": ("ai_reasoning", "compromise_explanation")}),
        ("Voting", {"fields": ("vote_count", "is_winner")}),
        ("Metadata", {"fields": ("created_at", "updated_at")}),
    )
...
class ItineraryVoteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("id", "option", "user", "group")}),
        ("Vote Details", {"fields": ("comment", "voted_at")}),
    )
