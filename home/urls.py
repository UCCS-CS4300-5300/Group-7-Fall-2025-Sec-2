...
from .views import index, trip_list, submission_status, submit_preferences, view_preferences
...
urlpatterns = [
    ...
    path("trips/<int:trip_id>/preferences/", view_preferences, name="view_preferences"),
]
