...
TESTING = (
    ...
    or "coverage" in sys.argv[0]
    and "test" in " ".join(sys.argv)
)
...
# Use manifest storage in production for cache-busting, but fall back to the
# default storage while running tests so collectstatic is not required on CI.
if TESTING:
